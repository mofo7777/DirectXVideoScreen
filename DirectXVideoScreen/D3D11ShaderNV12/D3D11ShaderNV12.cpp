...
HRESULT CD3D11ShaderNV12::ProcessShaderNV12(LPCWSTR wszOutputImageFile, const enum SHADER_CONVERSION ShaderConversion)
{
	HRESULT hr = S_OK;
	...
	else if(ShaderConversion == CONVERT_CHROMA_SHADER)
	{
		...
		IF_FAILED_RETURN(CreateBmpFileFromChromaSurface(m_pChromaRT, wszOutputImageFile, TRUE));
	}
	else
	{
