...
private:
	...
	ID3D11RenderTargetView* m_pChromaBRT = NULL;
	ID3D11RenderTargetView* m_pChromaCRT = NULL;
	ID3D11RenderTargetView* m_pChromaDownSampledRT = NULL;
	ID3D11RenderTargetView* m_pChromaBDownSampledRT = NULL;
	ID3D11RenderTargetView* m_pChromaCDownSampledRT = NULL;
	...
	ID3D11ShaderResourceView* m_pChromaBRSV = NULL;
	ID3D11ShaderResourceView* m_pChromaCRSV = NULL;
	ID3D11ShaderResourceView* m_pChromaDownSampledRSV = NULL;
	ID3D11ShaderResourceView* m_pChromaBDownSampledRSV = NULL;
	ID3D11ShaderResourceView* m_pChromaCDownSampledRSV = NULL;
	...
	ID3D11PixelShader* m_pChromaDownSampledShader2 = NULL;
	ID3D11PixelShader* m_pCombinedYUVPixelShader = NULL;
	...
	void ProcessChromaDownSampledShader2(ID3D11VertexShader*, ID3D11PixelShader*);
	void ProcessFakeNV12Shader();
	void ProcessNV12Shader();
