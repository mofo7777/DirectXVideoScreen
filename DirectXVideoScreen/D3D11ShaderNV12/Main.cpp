...
void main()
{
	...
	if(cD3D11ShaderNV12.InitShaderNV12(cWICBitmap) == S_OK)
	{
		...
		// CONVERT_CHROMADWONSAMPLED_SHADER (not correct)
		// CONVERT_FAKE_NV12_SHADER (not implemented)
		// CONVERT_NV12_SHADER (not implemented)
		cD3D11ShaderNV12.ProcessShaderNV12(cWICBitmap.GetWidth(), cWICBitmap.GetHeight(), CONVERTED1_IMAGE, CONVERTED2_IMAGE, CONVERTED3_IMAGE, CD3D11ShaderNV12::SHADER_CONVERSION::CONVERT_CHROMADWONSAMPLED_SHADER);
	}
